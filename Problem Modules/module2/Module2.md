...
For the objective function we need constraints. The constraints are going to be that _all regions need to be covered by at least one site_:
...
Next we modeled it trying to find the minimum connections needed to get _at least_ 35Mbit/s. With new variables:
